<template>
  <header
    class="header w-full flex flex-row justify-between items-center fixed top-0 duration-[0.5s] transition-all z-[111] px-[15px] md:px-[30px] lg:hidden rounded-none"
