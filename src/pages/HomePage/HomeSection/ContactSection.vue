    ...
    >
      <div class="form__top-box flex flex-col justify-center items-start">
        ...
        <p
          ...
          v-motion-pop-visible-once
        >
          У нас есть любые сложные цифровые системы с точки зрения требований
          описываем, составляем подробную проектную документацию
        </p>
      </div>
      <form
      ...
      >
        ...
        >
          <input
            ...
            id="username"
            autocomplete="off"
            class="form__number-text w-full bg-blue bg-[#a11737] font-semibold text-white border-[1px] border-[#560F20] rounded-[57px] py-4 pl-[18px] outline-none md:py-[18px] md:pl-6 md:border-e-0 md:rounded-e-none md:w-max md:pr-0 lg:pr-20"
            placeholder="Имя"
            required
          />
          ...
          <div class="w-full">
            ...
            <input
              ...
              id="tel"
              autocomplete="off"
              class="form__number-input w-full bg-[#a11737] font-semibold text-white border-[1px] border-darker-pink rounded-[57px] py-4 pl-[18px] outline-none md:py-[18px] md:pl-6 md:border-s-0 md:rounded-s-none lg:pr-48 lg:w-max lg:relative"
          ...
          <button
            type="submit"
            class="form__butto w-full text-red-600 flex flex-row justify-center items-center rounded-[57px] py-4 border-[2px] border-darker-pink bg-white font-semibold gap-[15px] md:absolute md:w-max md:px-[20px] md:py-3 md:right-[2px] active:opacity-30 duration-150"
          >
            Отправить
