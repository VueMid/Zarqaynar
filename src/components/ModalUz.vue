    ...
    >
      ...
      >
        ...
        <p class="header__warning text-[11px] w-[315px] text-center text-gold">
          “Yuborish” tugmasini bosish orqali siz roziligingizni tasdiqlaysiz
  ...
  methods: {
    validatedForm() {
      ...
      if (this.username.length === 0) {
        isValid = false;
        this.error.nameError = "*Bu yerda toʻliq ismingizni kiriting";
      } else {
        isValid = true;
    ...
    validatedFormThird() {
      ...
      if (this.message.length === 0) {
        isValidThird = false;
        this.errorThird.nameErrorThird = "*Xabaringizni shu yerga kiriting";
      } else {
        isValidThird = true;
